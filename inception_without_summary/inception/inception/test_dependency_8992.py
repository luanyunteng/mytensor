...
allpre_8992 = dict()
for pre in dic[8992]:
    allpre_8992[pre] = get_subgraph(pre)
...
for key in allpre_8992:
    replacement_list = allpre_8992[key]
    ...
    for i in range(1000):
        sess.run(train_op)
    dur = (time.clock() - start) * 1000 / 1000
    print("key: ", key, "    time: ", dur)
    logWriter = open('time_log_8992.txt', 'a')
