...
path = list()
filereader = open('result_by_graph_1_minibatch32_299_inference_withtrain', 'r')
...
print('read path')
pathtime = list()
filereader = open('time_by_graph_1_minibatch32_299_inference_withtrain', 'r')
line = filereader.readline()
while line:
...
logWriter = open('log32299_inference_withtrain.txt', 'a')
