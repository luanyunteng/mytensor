...
np.random.seed(1)
ima = np.random.ranf(size=[64, 128, 128, 3])
...
path = list()
filereader = open('result_by_graph_1_minibatch64_128', 'r')
...
print('read path')
pathtime = list()
filereader = open('time_by_graph_1_minibatch64_128', 'r')
line = filereader.readline()
while line:
